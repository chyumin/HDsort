...
%             self.getWaveformAccessSwitch = 1; % This sets individual access as default. Very slow for many spikes
            ...
            try
                ...
                self = hdsort.file.hdf5.createVariableAndOrFile(fname, h5path, dims, maxDims, h5type, chunkDims, deflation, bReadOnly);
            end
        end
        % DESTRUCTOR
        %------------------------------------------------------------------
...
%             end
        ...
        function X = getData(self, varargin)
            ...
            X = hdsort.file.hdf5.read_dset(self.datasetID, block, offset);
        ...
        function setData(self, X, varargin)
            [bb relIdx] = hdsort.file.hdf5.getBoundingBoxFromIndexing(self.dims, varargin{:});
            ...
            hdsort.file.hdf5.write_dset(self.datasetID, X, offset);
        end 
...
%     methods (Access = private)
        ...
        function getProps(self)
            ...
            self.propInfo = hdsort.file.hdf5.h5propinfo(plist);
        end
