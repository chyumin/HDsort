...
proc = hdsort.file.hdf5.createVariableAndOrFile(fileName, '/bFileIsInProcess', [1 1], [1 1], 'H5T_NATIVE_INT');
proc(1,1) = int32(1);
...
frames = hdsort.file.hdf5.createVariableAndOrFile(fileName, '/ephys/frame_numbers', ...
...
signal = hdsort.file.hdf5.createVariableAndOrFile(fileName, '/ephys/signal', ...
