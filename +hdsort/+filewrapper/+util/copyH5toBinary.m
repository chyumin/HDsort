...
data = hdsort.filewrapper.hdf5.matrix(inFile, [P.sessionName '/sig'], true);
...
l = length(filterType);
ord = hdsort.filewrapper.hdf5.createVariableAndOrFile(outFile, [P.sessionName '/filter/type'], [1 l], [1 l], 'H5T_C_S1');
...
x = hdsort.filewrapper.hdf5.createVariableAndOrFile(outFile, [P.sessionName '/channel_nr'], [1 nC], [1 nC], 'H5T_NATIVE_DOUBLE');
x(1,:) = h5read(inFile, [P.sessionName '/channel_nr']);
clear x
x = hdsort.filewrapper.hdf5.createVariableAndOrFile(outFile, [P.sessionName '/channel_posx'], [1 nC], [1 nC], 'H5T_NATIVE_DOUBLE');
x(1,:) = h5read(inFile, [P.sessionName '/channel_posx']);
clear x
x = hdsort.filewrapper.hdf5.createVariableAndOrFile(outFile, [P.sessionName '/channel_posy'], [1 nC], [1 nC], 'H5T_NATIVE_DOUBLE');
x(1,:) = h5read(inFile, [P.sessionName '/channel_posy']);
clear x
x = hdsort.filewrapper.hdf5.createVariableAndOrFile(outFile, [P.sessionName '/channel_connected'], [1 nC], [1 nC], 'H5T_NATIVE_DOUBLE');
