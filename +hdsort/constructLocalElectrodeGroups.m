...
%     P.maxOverlapPerGroup = 6;
    ...
    while 1
        ...
        notInThisGroup = ~ismember(1:N, groups{currentGroup})';
        ...
        if size(groups{currentGroup},1) < P.maxElPerGroup
            ...
            group2 = find(D>P.addIfNearerThan & D<P.maxDistanceWithinGroup & notInAnyGroup & notInThisGroup);
            ...
            if size(groups{currentGroup},1) < P.maxElPerGroup
                ...
                group3 = find(D>P.addIfNearerThan & D<P.maxDistanceWithinGroup & ~notInAnyGroup & notInThisGroup);
        ...
        assert(length(groups{currentGroup}) == length(unique(groups{currentGroup} )), 'Must be identical!!')
