classdef MultiSessionChildWfManager < hdsort.waveforms.MultiSessionBufferedWfManager
    ...
    methods
        ...
        function self = MultiSessionChildWfManager(wfbufferParent, subSelectionIdx)       
            self = self@hdsort.waveforms.MultiSessionBufferedWfManager(wfbufferParent.wfDataSource,...
        ...
        function wfManager = getWfManger4SubIdx(self, idx)
            wfManager = hdsort.waveforms.MultiSessionChildWfManager(...
